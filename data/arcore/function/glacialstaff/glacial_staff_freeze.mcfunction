...
execute at @e[tag=GlacialProjectile,limit=1,sort=nearest] as @e[distance=..3.5,type=!armor_stand,type=!item_display,tag=!frozen,type=!item,type=!stray,type=!marker] run tag @s add frozen
