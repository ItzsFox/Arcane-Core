...
execute rotated as @s positioned 0.0 0.0 0.0 positioned ^ ^.1 ^-1 summon area_effect_cloud run data modify entity @e[tag=pusher,limit=1] Motion set from entity @s Pos
